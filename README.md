...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/google-colab-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11889&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/google-colab-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `google-colab` can be installed with:

```
conda install google-colab
```

It is possible to list all of the versions of `google-colab` available on your platform with:
